...
#Date:2022-09-15
#Version:0.0.1
#amd64v3 only, with pre-releases
#####################################################
...
set_as_entrance() {
    if [[ ! -f "${SCRIPT_FILE_PATH}" ]]; then
        wget --no-check-certificate -O ${SCRIPT_FILE_PATH} https://raw.githubusercontent.com/zswdcx/sing-box-yes/main/install-v3.sh
